    ...
    return (
        ...
        `}
            ...
            >
                ...
                {isHovered && (
                    <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-black/90 backdrop-blur-sm rounded text-xs text-white whitespace-nowrap pointer-events-none">
                        {label}
                    </div>
                )}
            </div>
    ...
    return (
        ...
        >
            <div
                ...
                style={{
                    // Fade effect: Transparent center -> Subtle Black Edge
                    background: `radial-gradient(circle, transparent 40%, rgba(0, 0, 0, 0.02) 70%, rgba(0, 0, 0, 0.1) 100%)`,
    ...
    return (
        <div className="w-full flex items-center justify-center overflow-hidden">
            ...
            >
                ...
                {/* Central "Code" Icon - Black/Grey Theme */}
                <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-black to-gray-800 rounded-full flex items-center justify-center z-10 relative shadow-2xl">
                    {/* Removed colored glows, kept shadow */}
